...
public class UserInfoModifyService {
    ...
    public void modifyUserInfo(UserInfoModifyDTO userInfoModifyDTO){
...
//        }
        ...
        if(userInfoModifyDTO.getAccountHolder() != null && !userInfoModifyDTO.getAccountHolder().isEmpty()){
            user.setAccountHolder(userInfoModifyDTO.getAccountHolder());
        }
        if(userInfoModifyDTO.getBankName() != null && !userInfoModifyDTO.getBankName().isEmpty()){
            user.setBankName(userInfoModifyDTO.getBankName());
        }
        if(userInfoModifyDTO.getAccountNumber() != null && !userInfoModifyDTO.getAccountNumber().isEmpty()){
            user.setAccountNumber(userInfoModifyDTO.getAccountNumber());
        }
